...
class EditCustomer extends React.Component {
  ...
  createNewCustomers = () => {
    ...
    this.props
      ...
      .then((res) => {
        ...
        this.props
          .listData("hiring/customer/list", this.props.id_token, false)
          .then((res) => {
            this.props.setmounted(false);
            this.setState({
              loading: false,
              dp: this.props.new_customer.id,
            });
            ...
            if (
              ...
              store.addNotification({
                ...
                message: "Customer entry edited Successfully",
              ...
              // this.props.listData("allcustomers", this.props.id_token, false);
            } else {
              store.addNotification({
                title: (
                  <Chip
                ...
                message: "Customer entry was Not edited Successfully",
  ...
  render() {
    if (this.state.loading) {
      ...
      return (
        <div>
          <form autoComplete="on" onSubmit={this.createNewCustomers}>
...
const mapStateToProps = (state) => {
  return {
    ...
    new_customer: state.api.post_data,
  };
};
