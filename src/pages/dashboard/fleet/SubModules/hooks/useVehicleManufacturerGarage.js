...
export default function useVehicleManufacturerGarageForm(
  id = false,
  handleClickClose,
  data
) {
  ...
  const [callToAction, setCallToAction] = useState({
    ...
    err: "Error creating manufacturer garage.",
    success: "Manufacturer Garage created.",
  });
  ...
  useEffect(() => {
    if (id) {
      ...
      setCallToAction({
        ...
        url: "manufacturers/garages",
        err: "Error updating!",
        success: "Manufacturer Garage Updated.",
      });
    }
  }, [id, data]);
