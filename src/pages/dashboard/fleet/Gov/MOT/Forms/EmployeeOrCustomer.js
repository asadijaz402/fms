...
export default function EmployeeOrCustomer({
  value,
  onChange,
  handleNext,
  handleBack,
  ...
  const onSubmit = (e) => {
    ...
    } else if (showForm === "employee_name") {
      onChange({
        target: {
          name: "customer",
          value: "",
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={12} md={6} lg={6}>
          <Button
            ...
            fullWidth
            color="primary"
            variant={showForm === "employee_name" ? "contained" : "outlined"}
          >
            Employee
          </Button>
        </Grid>
